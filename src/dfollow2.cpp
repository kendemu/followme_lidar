...
const double follow_speed = 0.6;        // 追跡するときの基準速度 FMT用 0.6 家用 0.3
...
const double gain_proportion  = 0.1;  // 比例航法のゲイン FMT用 0.1 家　10
const double linear_max_speed   = 0.6;  // FMT用 0.6  家用 0.3 　最大　
const double turn_max_speed     = 0.6;  // FMT用 0.6　家用 1.2 　最大　3.14
